...
public final class console {
    public static void log(String key) {
        if (key.startsWith("AUTON HALP") && !DriverStation.isAutonomous()) return; // TODO TERRIBLE
    ...
    public static <T> T log(String key, T value, Object... others) {
        if (key.startsWith("AUTON HALP") && !DriverStation.isAutonomous()) return value; // TODO TERRIBLE
